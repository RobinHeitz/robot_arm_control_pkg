...
class ServoController:
    ...
    """
    Winkel: 0-180 °
    Tastverhaeltnis = Ausgang 5V / (Ausgang 5V + Ausgang 0)  <-- Nenner ist quasi Periodendauer
    Frequenz 50Hz --> eine Periode des Signals dauert 20ms 
    Tastverhältnis == Duty cycle

    2% Tastverhältnis 0 deg --> 0.4 ms Signallänge
    7% Tastverhältnis 90 deg --> 1.4 ms Signallänge
    11% Tastverhältnis 180 deg --> 2.2 ms Signallänge
